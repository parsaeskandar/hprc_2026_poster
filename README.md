...
- `talk/HPRC2026_talk.pptx`: the deck (19 slides + 5 backup), speaker notes on every slide; drop screen recordings into `talk/figures/videos/` as `scenario1.mp4` and `scenario2.mp4` and rebuild to embed them.

    ...
    \node[fill=chipbg, rounded corners=3mm, inner sep=0pt] (win)
      {\begin{minipage}{0.94\linewidth}
        ...
        \IfFileExists{figures/#1}{%
          \centering\includegraphics[width=\linewidth,height=#2,keepaspectratio]{figures/#1}\par
        }{%
          \begin{tikzpicture}
...
\RaggedRight
The HPRC v2.0 graph holds \textbf{233 samples and 464 haplotypes}. You can
browse each assembly, but you cannot simply ask the graph a question: which
...
between any two of the 466 assemblies, at interactive speed.}
...
especially Adam Novak, Glenn Hickey, and Zia Truong, and the UCSC Genome
Browser team. Built on \texttt{vg} and the HPRC v2.0 graph.
\end{card}
...
\ Nodes visited exactly once by both source and target make guaranteed
orthologous anchor pairs. \ {\bfseries\color{navy}4} \ A walk between
...
\begin{card}
\cardhead{06}{Convert between assemblies}
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[poster, width=0.88\linewidth, height=6.5cm,
  xbar, xmode=log, xmin=8, xmax=60000,
  symbolic y coords={1 Mb, 100 kb, 10 kb, 1 kb, 100 bp},
  ytick=data, bar width=0.58cm,
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[poster, width=0.88\linewidth, height=6.2cm,
...
\iconrow{\faRocket}{Public release}{Pangenome search and translation in
the public UCSC Genome Browser.}
\iconrow{\faDatabase}{Precomputed chains}{Offline whole-genome chains for
every pair, so lifted tracks pan freely.}
\iconrow{\faBolt}{Chromosome-scale conversion}{Whole chromosomes
